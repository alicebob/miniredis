...
func TestGeoradius(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		testCommands(t,
			...
			succ("GEORADIUS", "stations", 1.0, 1.0, 1, "km"),
			...
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 4, "m", "WITHCOORD"),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHDIST", "WITHCOORD"),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHCOORD", "WITHDIST"),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHCOORD", "WITHCOORD", "WITHCOORD"),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHDIST", "WITHDIST", "WITHDIST"),
			// FIXME: the distances don't quite match for miles or km
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "mi", "WITHDIST"),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHDIST"),

			// Sorting
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "DESC"),
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC"),
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "DESC", "ASC"),

			// COUNT
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "COUNT", 1),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "COUNT", 2),
			succRound3("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "COUNT", 999),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "COUNT"),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "COUNT", 0),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "COUNT", -12),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "COUNT", "foobar"),

			// non-existing key
			succ("GEORADIUS", "foo", -73.9718893, 40.7728773, 4, "km"),

			// no error in redis, for some reason
			// fail("GEORADIUS", "foo", -73.9718893, 40.7728773, 4, "km", "FOOBAR"),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "FOOBAR"),

			// GEORADIUS_RO
			succ("GEORADIUS_RO", "stations", -73.9718893, 40.7728773, 4, "km"),
			succ("GEORADIUS_RO", "stations", 1.0, 1.0, 1, "km"),
			fail("GEORADIUS_RO", "stations", -73.9718893, 40.7728773, 4, "km", "STORE", "bar"),
			fail("GEORADIUS_RO", "stations", -73.9718893, 40.7728773, 4, "km", "STOREDIST", "bar"),
			fail("GEORADIUS_RO", "stations", -73.9718893, 40.7728773, 4, "km", "STORE"),
			fail("GEORADIUS_RO", "stations", -73.9718893, 40.7728773, 4, "km", "STOREDIST"),
		)
	})
	...
	t.Run("STORE", func(t *testing.T) {
		testCommands(t,
			...
			// plain store
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STORE", "foo"),
			succ("ZRANGE", "foo", 0, -1),
			succ("ZRANGE", "foo", 0, -1, "WITHSCORES"),

			// Yeah, valid:
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STORE", ""),
			succ("ZRANGE", "", 0, -1),

			// store with count, and overwrite existing key
			succ("EXPIRE", "foo", 999),
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "COUNT", 1, "STORE", "foo"),
			succ("ZRANGE", "foo", 0, -1),
			succ("TTL", "foo"),
			...
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STORE", "taken"),
			succ("TYPE", "taken"),
			succ("ZRANGE", "taken", 0, -1),
			succ("TTL", "taken"),

			// errors
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STORE"),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHDIST", "STORE", "foo"),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHCOORD", "STORE", "foo"),
		)
	})
	...
	t.Run("STOREDIST", func(t *testing.T) {
		testCommands(t,
			...
			// plain store
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STOREDIST", "foo"),
			succ("ZRANGE", "foo", 0, -1),
			succRound3("ZRANGE", "foo", 0, -1, "WITHSCORES"),

			// plain store, meter
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "m", "STOREDIST", "meter"),
			succ("ZRANGE", "meter", 0, -1),
			succRound3("ZRANGE", "meter", 0, -1, "WITHSCORES"),

			// Yeah, valid:
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STOREDIST", ""),
			succ("ZRANGE", "", 0, -1),

			// STOREDIST with count
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "ASC", "COUNT", 1, "STOREDIST", "foo"),
			succ("ZRANGE", "foo", 0, -1),

			// store should overwrite
			succ("SET", "taken", 123),
			succ("EXPIRE", "taken", 9999),
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STOREDIST", "taken"),
			succ("TYPE", "taken"),
			succ("ZRANGE", "taken", 0, -1),
			succ("TTL", "taken"),

			// multiple keys
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STOREDIST", "n1", "STOREDIST", "n2", "STOREDIST", "n3"),
			succ("TYPE", "n1"),
			succ("TYPE", "n2"),
			succ("TYPE", "n3"),

			// STORE and STOREDIST
			succ("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STOREDIST", "a", "STORE", "b"),
			succ("TYPE", "a"),
			succ("ZRANGE", "a", 0, -1),
			succ("TYPE", "b"),
			succ("ZRANGE", "b", 0, -1),
			...
			// errors
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "STOREDIST"),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHDIST", "STOREDIST", "foo"),
			fail("GEORADIUS", "stations", -73.9718893, 40.7728773, 400, "km", "WITHCOORD", "STOREDIST", "foo"),
		)
	})
}
